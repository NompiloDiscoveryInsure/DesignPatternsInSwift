//
//  Open-Closed_Principle.swift
//  
//
//  Created by Nompilo Moyo on 2023/11/30.
//
//Open-Closed Principle (OCP) is a guiding principle that promotes these qualities by encouraging developers to design code that is open for extension but closed for modification.
